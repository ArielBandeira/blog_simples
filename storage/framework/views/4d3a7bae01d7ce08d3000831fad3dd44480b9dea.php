  ...
  <!--- ARTIGOS --->
      <div class="col-sm-8">
        <?php $__currentLoopData = $artigos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $artigo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <a href="#"><h2>Título do Artigo: <?php echo e($artigo -> titulo); ?></h2></a>
          <h5>ID do autor: <?php echo e($artigo -> id_autor); ?></h5>
          <img class="img-fluid" src="http://localhost/blog_noticias/public/images/<?php echo e($artigo -> imagem); ?>" alt="coffe" class="fakeimg">
          <br>
