  ...
  <!--- AUTORES --->
      <div class="col-sm-8">
        @foreach($autores as $autor)
          ...
          <br>
          <img class="img-fluid" src="http://localhost/blog_noticias/public/images/profiles/{{$autor -> profile_pic}}" alt="autor" class="profile_img" width="500" height="200">
          <br><br>
          <p>{{$autor -> bio}}</p>
          <br><br>
        @endforeach
      ...
      <div class="col-sm-4">
        ...
        <div class="some_links">
          ...
          <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="{{route('sobreMim')}}">Sobre Mim</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{route('contato')}}">Contato</a>
            </li>
